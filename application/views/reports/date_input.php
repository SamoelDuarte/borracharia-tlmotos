...
?>
	...
	<div id='report_sale_type'>
		<?php echo form_dropdown('sale_type',array('all' => $this->lang->line('reports_all'), 'sales' => $this->lang->line('reports_sales'), 'returns' => $this->lang->line('reports_returns'), 'deletions' => $this->lang->line('reports_deletions')), 'all', 'id="sale_type"'); ?>
	</div>
<?php
